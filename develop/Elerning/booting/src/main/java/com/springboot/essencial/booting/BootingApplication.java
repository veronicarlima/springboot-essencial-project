...
import com.springboot.essencial.booting.data.repository.RoomRepository;
...
public class BootingApplication {
	...
	public static void main(String[] args) {
        ...
        */
        ...
        //vamos para o codigo PARA TESTAR O REPOSITORY - COLOCANDO UM COMANDO PARA CHAMAR
                SpringApplication.run(BootingApplication.class, args);}

            @Bean
            public CommandLineRunner runner(RoomRepository repository){
                return args -> {
                    repository.findAll().forEach(System.out::println);
                };
            }
        //TAMBEM FOI COLOCADO UMA DEPENDENCIA PARA PODER ACESSAR A INTERFACE DO DATABASE H2 JA QUE NAO ESTAVA ABRINDO. RESOLVEU SE ACESSAR LOCALHOST:8080/H2-CONSOLE VAI ABRIR A INTERFACE
         */
    }
}
